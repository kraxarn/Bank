	...
	public partial class MoneyPage
	{
		...
		private async void Button_OnClicked(object sender, EventArgs e)
		{
			...
			switch (text)
			{
				...
				case "Send":
					if (TotalMoney < fromUser.Money * 0.02f && !await DisplayAlert("You sure about that?", $"{FormattedMoney} is not a lot. Are you sure you entered it correctly?", "Yeah", "No lol"))
						return;
